...
import {AuthContext} from "@/library/pageComponents/AuthContext.js";
...
export default function Header({setUser}) {
    ...
    const alt = location.pathname === "/upload" ? "Archive Icon" : "Video Upload Icon";
    ...
    return (
        <header className="grid grid-cols-3 items-center h-20 px-4 bg-gray-300">
            ...
            <h1 className="pl-6 sm:pl-0 text-xl sm:text-3xl md:text-4xl font-bold tracking-wider sm:text-center text-ergo-rot">Video
                Upload</h1>
            {user !== null && (
                <button
